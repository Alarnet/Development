Для переменных **коллекции** работа с переменными происходит таким же образом, только вместо *globals* мы теперь используем ***collectionVariables*** и работаем с переменными текущей коллекции.
